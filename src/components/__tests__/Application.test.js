...
import { render, cleanup, waitForElement, fireEvent, getByText, getByPlaceholderText, prettyDOM, getAllByTestId, getByAltText, queryByText } from "@testing-library/react";
...
describe("Application", () => {
  ...
  it("shows the save error when failing to save an appointment", async () => {
    ...
    //expect spots remaining has not changed
    const day = getAllByTestId(container, "day").find(day =>
      queryByText(day, "Monday")
    );
    expect(queryByText(day, "1 spot remaining"))
